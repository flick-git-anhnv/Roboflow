...
| 2026-08-06 | Antigravity | Sửa Undo/Redo canvas snapshot, reload trang khi đóng modal phân công & tính ảnh completed vào tiến độ, hỗ trợ hotkey số 0-9 & tắt MRU mapping tự động, thêm thanh menu chỉnh kích thước thumbnail (sizemenu) và chuyển thanh điều hướng sang dạng menu bên (sidemenu) | feature/roboflow-upgrade |
